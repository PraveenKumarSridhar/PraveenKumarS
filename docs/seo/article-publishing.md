...
2. Add `_notes/your-article-slug.md` on a branch. Keep the slug stable after publication.
...
| Browser | Mobile clipping/overflow, hidden navigation/content, broken writing button, failed images, JavaScript errors, inaccessible table scrolling |
