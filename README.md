...
For a local preview, run `python3 scripts/preview_site.py` and open the localhost URL it prints. This command builds the site and serves the generated output. It rejects the source directory if passed with `--site-dir`.
